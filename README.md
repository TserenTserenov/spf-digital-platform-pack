...
**ИИ-системы** и **детерминированные системы** — виды **систем платформы** (DP.D.015). Каждый слой взаимодействует только с соседним. Интерфейс не лезет в хранилище, ИИ-система не знает какой UI у пользователя.
