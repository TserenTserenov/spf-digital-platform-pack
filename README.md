...
Слой 2: Сервисы + MCP     — детерминированные системы + инструменты данных
Слой 1: Хранилище          — БД, файлы, индексы
```

Каждый слой взаимодействует только с соседним. Интерфейс не лезет в хранилище, ИИ-система не знает какой UI у пользователя.
