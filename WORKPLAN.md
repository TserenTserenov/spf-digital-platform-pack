...
| Fix: виды vs характеристики, обучаемость active | 0.5h | **done** | [x] D.DTP.009 исправлен, [x] DP.AGENT.001, [x] DP.ARCH.001, [x] DP.ASSIST.001 |
| README.md + WORKPLAN.md обновления | 0.5h | in-progress | [ ] README с основными идеями, [x] WORKPLAN актуален |
...
- [ ] Метод: DP.METHOD.002 — навигация знаний (как найти нужное в системе Pack'ов)
