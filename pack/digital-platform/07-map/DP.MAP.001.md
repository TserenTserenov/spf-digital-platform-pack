...
| ID | Название | Статус | Описание |
|----|----------|--------|----------|
| [DP.METHOD.001](../03-methods/DP.METHOD.001-knowledge-extraction.md) | Метод экстракции знаний | draft | 5 шагов: обнаружение → классификация → маршрутизация → формализация → валидация |
...
| DP.AISYS.013 | DP.METHOD.001 | Реализует метод экстракции |
| DP.METHOD.001 | DP.WP.001 | Метод порождает рабочий продукт |
| DP.METHOD.001 | DP.FM.001 | Нарушение метода → failure mode |
...
| DP.METHOD.001 (экстракция) | `spf-personal-pack`, `spf-ecosystem-pack` | Метод применим ко всем Pack'ам |
