...
**Отчёт экстракции** — рабочий продукт метода экстракции знаний (DP.METHOD.001): структурированный список кандидатов на запись в Pack с классификацией, маршрутом и вердиктом.
...
- [DP.METHOD.001 Метод экстракции](../03-methods/DP.METHOD.001-knowledge-extraction.md) — метод, порождающий этот рабочий продукт
