...
| 15 | Цифровой двойник | `/twin` | 📋 | Персональный профиль: данные об обучении, интересах и прогрессе для рекомендаций | Personal profile: learning data, interests, and progress for recommendations |
