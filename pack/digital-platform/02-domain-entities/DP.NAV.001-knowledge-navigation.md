...
> Навигация ≠ Поиск (D.DTP.013). Навигация знает структуру. Поиск ищет по содержимому. Оба нужны, но они дополняют друг друга.
...
| «Какие FM связаны с D.DTP.012?» | Навигация → Карта → Кросс-ссылки | 3-4 |
