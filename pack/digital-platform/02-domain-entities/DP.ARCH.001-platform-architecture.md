...
│  (ИИ-агенты и ИИ-ассистенты — виды ИИ-систем, D.DTP.009)    │
└───────────────────────────┬─────────────────────────────────┘
                            ▼
┌─────────────────────────────────────────────────────────────┐
│  СЛОЙ 2: СЕРВИСЫ + MCP (детерминированные системы)           │
...
| **2. Сервисы + MCP** | Доступ к данным и функциям через стандартный протокол | Детерминированные (ai_role: none/feature) | Twin, Hub, CRM, LMS, ORY, Биллинг, Event Bus, MCP-серверы |
...
> Характеристика ≠ Принцип (D.DTP.010). Характеристика — измеряемое качество. Принцип — правило для достижения характеристики.
...
> Platform-space ≠ User-space (D.DTP.011)
