...
| **ИИ-система** | Компонент платформы, использующий LLM для выполнения функций. Может быть ИИ-агентом (ориентация на систему, автономная инициатива) или ИИ-ассистентом (ориентация на человека, по запросу) — это характеристики, а не разные типы |
