...
Неформализованная информация (заметки, черновики, сырые тексты) размещается напрямую в Pack-репозитории, минуя метод экстракции (DP.METHOD.001).
...
> Нарушает различение: Знание ≠ Информация (D.DTP.012)
...
**Если хотя бы один ответ «Нет»** — запись не готова для Pack. Нужна экстракция (DP.METHOD.001).
...
- [D.DTP.012 Знание ≠ Информация](../01-domain-contract/01B-distinctions.md) — нарушаемое различение
- [DP.METHOD.001 Метод экстракции](../03-methods/DP.METHOD.001-knowledge-extraction.md) — метод, предотвращающий ошибку
