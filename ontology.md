...
| **Файл контекста РП** | Накопленный контекст многосессионного РП: что сделано, что обнаружено, что дальше. Производится Close-протоколом, потребляется Open-протоколом | U.Work + U.Episteme | DP.EXOCORTEX.001, DP.D.014 |
